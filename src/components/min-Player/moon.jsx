export default function moon({size = 24, width, height, ...props}) {
    return (
        <svg t="1697010995368" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="4274"
             height={size || height}
             width={size || width}
             {...props}>
